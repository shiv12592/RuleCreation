...
const RuleConditionRows = ({ onData }) => {
  ...
  const handleAddConditionRow = () => {
    ...
    setIsSubmitDisabled(false); // Re-enable submit button when a new row is added
  };
  ...
  const handleChange = (index, field, value) => {
    ...
    setIsSubmitDisabled(false); // Re-enable submit button when any field changes
  };
  ...
  const handleChangeInner = (index, i, field, value) => {
    ...
    setConditions(updatedConditions);
    setIsSubmitDisabled(false); // Re-enable submit button when any field changes within nested rows
  };
