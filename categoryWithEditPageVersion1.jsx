...
const RuleCategoryChangeEditApproval = ({ defaultCategory, defaultCarId, defaultRuleOwner, onChange }) => {
    ...
    const [ruleOwner, setRuleOwner] = useState(defaultRuleOwner || '');
    ...
    const handleCategoryChange = (e) => {
        ...
        onChange({ category: selectedCategory, carId, ruleOwner });
    };

    useEffect(() => {
        // Load users when the component mounts
        dispatch(loadUsers(inputCarIdText));
    }, []);
